<?php
if (!class_exists('GNA_Miscellaneous_Config')) {
	class GNA_Miscellaneous_Config{
		var $configs;
		var $message_stack;
		static $_this;
		...
		function load_config() {
			$this->configs = get_option('g_miscellaneous_configs');
		}
		...
		function save_config() {
			update_option('g_miscellaneous_configs', $this->configs);
		}
		...
		static function get_instance(){
			if(empty(self::$_this)){
				self::$_this = new GNA_Miscellaneous_Config();
